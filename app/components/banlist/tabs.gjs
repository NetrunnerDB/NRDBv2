                              ...
                              <ul>
                                {{#if restriction.banned_subtype.length}}
                                  ...
                                  <li>
                                    ...
                                    <strong
                                    >{{restriction.formatted_banned_subtype}}</strong>
                                  </li>
                                {{/if}}
                        ...
                        {{#if restriction.obj.verdicts.global_penalty.length}}
                          <ul>
                            <li>
                              ...
                              <ul>
                                {{#each
                                  restriction.corp.global_penalty
                                  as |global_penalty|
                                }}
                                  <li>
                                    <CardLinkTo
                        ...
                        {{#if restriction.hasUniversalInfluence}}
                          <ul>
                            <li>
                              ...
                              <ul>
                                {{#if
                                  restriction.corp.threeUniversalInfluence.length
                                }}
                                  <li>
                                    <strong>3 Influence</strong>
                                    <ul>
                                      {{#each
                                        restriction.corp.threeUniversalInfluence
                                        as |card|
                                      }}
                                        <li>
                                          <CardLinkTo
                                ...
                                {{/if}}
                                {{#if
                                  restriction.corp.oneUniversalInfluence.length
                                }}
                                  <li>
                                    <strong>1 Universal Influence</strong>
                                    <ul>
                                      {{#each
                                        restriction.corp.oneUniversalInfluence
                                        as |card|
                                      }}
                                        <li>
                                          <CardLinkTo
                        ...
                        {{#if restriction.obj.verdicts.global_penalty.length}}
                          <ul>
                            <li>
                              ...
                              <ul>
                                {{#each
                                  restriction.runner.global_penalty
                                  as |global_penalty|
                                }}
                                  <li>
                                    <CardLinkTo
                            ...
                            <li>
                              ...
                              <ul>
                                <li>
                                  ...
                                  <ul>
                                    {{#each
                                      restriction.runner.threePoints
                                      as |card|
                                    }}
                                      <li>
                                        <CardLinkTo
                        ...
                        {{#if restriction.hasUniversalInfluence}}
                          <ul>
                            <li>
                              ...
                              <ul>
                                {{#if
                                  restriction.runner.threeUniversalInfluence.length
                                }}
                                  <li>
                                    <strong>3 Influence</strong>
                                    <ul>
                                      {{#each
                                        restriction.runner.threeUniversalInfluence
                                        as |card|
                                      }}
                                        <li>
                                          <CardLinkTo
                                ...
                                {{/if}}
                                {{#if
                                  restriction.runner.oneUniversalInfluence.length
                                }}
                                  <li>
                                    <strong>1 Universal Influence</strong>
                                    <ul>
                                      {{#each
                                        restriction.runner.oneUniversalInfluence
                                        as |card|
                                      }}
                                        <li>
                                          <CardLinkTo
